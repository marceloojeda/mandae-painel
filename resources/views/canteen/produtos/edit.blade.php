...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">Altera produto</div>

            <form action="/canteen/cardapio/{{ $produto->id }}" method="post">
                    @csrf
                    @method('PUT')
                    <div class="card-body">
                        @if (session('status'))
                        ...
                        <div class="form-group">
                            <div class="row">
                                ...
                                <div class="col-4 mb-2">
                                    ...
                                    <input type="text" class="form-control money2" name="preco" value="{{ $produto->preco_venda }}">
                                </div>
                                    ...
                                    <div class="input-group">
                                        <select class="custom-select" name="idCategoria" id="selectCategoria">
                                            ...
                                            @foreach ($categorias as $categoria)
                                                <?php $select = $produto->categoria_id == $categoria->id ? 'selected' : ''; ?>
                                                <option value="{{ $categoria->id }}" {{ $select }}>{{ $categoria->descricao }}</option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="col-4 mb-2">
                                    ...
                                    <div class="form-check pl-0">
                                        <?php $checked = $produto->ativo ? 'checked' : ''; ?>
