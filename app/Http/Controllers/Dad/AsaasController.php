...
class AsaasController extends Controller
{
    ...
    public function notificacao(Request $request){
        ...
        try {
            ...
            if(!$recargaCredito = $this->recargaCreditoRepo->getByTransacaoId($request->id)) {
            ...
            if(!empty($erroFaturar = $this->recargaCreditoRepo->confirmarRecarga($request->id))) {
                $retorno['erro'] = true;
            ...
            if(in_array($request->status, $arrStatusPagamento)) {
